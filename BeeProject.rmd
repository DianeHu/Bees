...
ncLCloth <- ggplot(cl, aes(x = logCloth, y = logNC)) + geom_point() + ggtitle("Number of Colonies vs Log nCLOTHIANIDIN")

ncLIMID <- ggplot(im, aes(x = logIMID, y = logNC)) + geom_point() + ggtitle("Number of Colonies vs Log nIMIDACLOPRID")

ncLTHIAM <- ggplot(thm, aes(x = logTHIAM, y = logNC)) + geom_point() + ggtitle("Number of Colonies vs Log nTHIAMETHOXAM")

ncLACET <- ggplot(ac, aes(x = logACET, y = logNC)) + geom_point() + ggtitle("Number of Colonies vs Log nACETAMIPRID")

ncLTHIAC <- ggplot(thc, aes(x = logTHIAC, y = logNC)) + geom_point() + ggtitle("Number of Colonies vs Log nTHIACLOPRID")
